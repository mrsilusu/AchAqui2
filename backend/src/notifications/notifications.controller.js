...
var NotificationsController = function () {
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.findAll = function (req, onlyUnread) {
            return this.notificationsService.findAllByUser(req.user.userId, onlyUnread === 'true');
        };
    ...
    (function () {
        ...
        _markAllAsRead_decorators = [(0, common_1.Patch)('read-all')];
