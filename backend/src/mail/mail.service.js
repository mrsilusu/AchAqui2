...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        ...
        MailService_1.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            this.logger.warn("Falha ao configurar Ethereal, a usar mock local: ".concat(String(error_1)));
                            this.transporter = nodemailer.createTransport({
                                jsonTransport: true,
                            });
                            return [3 /*break*/, 3];
        ...
        MailService_1.prototype.sendNewBookingEmail = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var subject, text, ownerResult, clientResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            subject = "Nova Reserva - ".concat(params.businessName);
                            text = "Nova reserva criada para ".concat(params.businessName, " de ").concat(params.startDate.toISOString(), " at\u00E9 ").concat(params.endDate.toISOString(), ".");
