...
exports.CreateOperatingHourDto = void 0;
var class_validator_1 = require("class-validator");
var CreateOperatingHourDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateOperatingHourDto() {
            ...
            return CreateOperatingHourDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _dayOfWeek_decorators = [(0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(0), (0, class_validator_1.Max)(6)];
            _openTime_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^([01]\d|2[0-3]):([0-5]\d)$/)];
            _closeTime_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^([01]\d|2[0-3]):([0-5]\d)$/)];
...
exports.CreateOperatingHourDto = CreateOperatingHourDto;
