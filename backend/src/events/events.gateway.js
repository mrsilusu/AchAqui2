...
var EventsGateway = function () {
    ...
    var _joinRoom_decorators;
    var EventsGateway = _classThis = /** @class */ (function () {
        function EventsGateway_1(jwtService) {
            this.jwtService = (__runInitializers(this, _instanceExtraInitializers), jwtService);
            this.logger = new common_1.Logger(EventsGateway.name);
            this.server = __runInitializers(this, _server_initializers, void 0);
            __runInitializers(this, _server_extraInitializers);
            this.jwtService = jwtService;
        }
        EventsGateway_1.prototype.handleConnection = function (client) {
            return __awaiter(this, void 0, void 0, function () {
                var token, payload, error_1;
                var _a, _b;
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.jwtService.verifyAsync(token, {
                                    secret: (_b = process.env.JWT_SECRET) !== null && _b !== void 0 ? _b : 'dev-secret-change-me',
                                })];
                        case 1:
                            payload = _c.sent();
                            client.data.user = {
                        ...
                        case 2:
                            error_1 = _c.sent();
                            this.logger.warn("Socket rejeitado: ".concat(String(error_1)));
        ...
        EventsGateway_1.prototype.joinRoom = function (client, body) {
            if (!client.data.user || client.data.user.userId !== body.userId) {
                throw new common_1.UnauthorizedException('Não autorizado para entrar nesta sala.');
            }
            client.join(this.getUserRoom(body.userId));
            return { joined: true, room: this.getUserRoom(body.userId) };
        };
        EventsGateway_1.prototype.emitToUser = function (userId, event, payload) {
            this.server.to(this.getUserRoom(userId)).emit(event, payload);
        };
        EventsGateway_1.prototype.getUserRoom = function (userId) {
            return "user:".concat(userId);
        };
        EventsGateway_1.prototype.extractTokenFromHeader = function (authorization) {
            if (!authorization) {
                return undefined;
            }
            var _a = authorization.split(' '), type = _a[0], token = _a[1];
            if (type !== 'Bearer') {
                return undefined;
            }
            return token;
        };
        return EventsGateway_1;
    }());
    __setFunctionName(_classThis, "EventsGateway");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _server_decorators = [(0, websockets_1.WebSocketServer)()];
        _joinRoom_decorators = [(0, websockets_1.SubscribeMessage)('joinRoom')];
        __esDecorate(_classThis, null, _joinRoom_decorators, { kind: "method", name: "joinRoom", static: false, private: false, access: { has: function (obj) { return "joinRoom" in obj; }, get: function (obj) { return obj.joinRoom; } }, metadata: _metadata }, null, _instanceExtraInitializers);
