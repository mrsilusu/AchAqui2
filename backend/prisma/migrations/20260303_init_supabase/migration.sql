...
-- CreateEnum
CREATE TYPE "BusinessCategory" AS ENUM ('HOSPITALITY', 'DINING', 'BEAUTY', 'PROFESSIONAL');
...
-- AddForeignKey
ALTER TABLE "OperatingHour" ADD CONSTRAINT "OperatingHour_businessId_fkey" FOREIGN KEY ("businessId") REFERENCES "Business"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
